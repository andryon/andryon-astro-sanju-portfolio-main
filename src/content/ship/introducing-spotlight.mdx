...
![Screenshot of spotlight announcement on GDG Discord server](https://assets.andryon/ships/spotlight-announcement-on-discord.png)
...
![Screenshot of WhatsApp conversation](https://assets.andryon/ships/whatsapp-conversation.png)
